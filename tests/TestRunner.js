...
import FluxCapacitorSpec from "./spec/FluxCapacitorSpec";
    ...
    execute: function () {
        ...
        var reactReporter = {
            ...
            specDone: function (result) {
                ...
                emitResult(result.status + " (" + result.passedExpectations.length + " passed, " + result.failedExpectations.length + " failed)", [spec_class, "spec_done"]);
